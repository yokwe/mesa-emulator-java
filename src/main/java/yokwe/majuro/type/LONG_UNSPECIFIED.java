...
public final class LONG_UNSPECIFIED extends MemoryData32 {
    ...
    public static final LONG_UNSPECIFIED longPointer(@Mesa.POINTER int base, MemoryAccess access) {
    ...
    private LONG_UNSPECIFIED(@Mesa.POINTER int base, MemoryAccess access) {
        super(base, access);
    }
}
