...
public final class PsbLink {
    ...
    public static final class priority {
        ...
        public static void set(@LONG_POINTER int base, @CARD16 int newValue) {
            Memory.modify(base + OFFSET, PsbLink.priority::setBit, newValue);
        }
    }
    public static final class next {
        ...
        public static void set(@LONG_POINTER int base, @CARD16 int newValue) {
            Memory.modify(base + OFFSET, PsbLink.next::setBit, newValue);
        }
    }
    public static final class failed {
        ...
        public static void set(@LONG_POINTER int base, boolean newValue) {
            Memory.modify(base + OFFSET, PsbLink.failed::setBit, (newValue ? 1 : 0));
        }
    }
    public static final class permanent {
        ...
        public static void set(@LONG_POINTER int base, boolean newValue) {
            Memory.modify(base + OFFSET, PsbLink.permanent::setBit, (newValue ? 1 : 0));
        }
    }
    public static final class preempted {
        ...
        public static void set(@LONG_POINTER int base, boolean newValue) {
            Memory.modify(base + OFFSET, PsbLink.preempted::setBit, (newValue ? 1 : 0));
        }
    }
}
